...
class _MapScreenState extends State<MapScreen> {
  ...
  List<IceUser> _buildUsers() {
    ...
    final base = <IceUser>[
      ...
      // âœ… 6 EXTRA users within ~1km of Username
      const IceUser(
        id: 5,
        name: 'Maya',
        lat: -33.8679,
  ...
  Future<void> _openDirections(IceUser u) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Are you sure you want to get directions to meet ${u.name}?',
    ...
    // If user confirmed, open the map
    if (confirmed == true) {
      final me = _me;
        ...
        child: Container(
          ...
          child: const Center(
            child: Text(
              ...
              style: TextStyle(
                color: Colors.white,
                fontSize: 22, // ⬅ bigger question mark
                fontWeight: FontWeight.w900,
                height: 1,
              ),
            ),
